...
<br>
   ...
   <?php    if (($_SESSION['cargo'] == 'Administrador') || ($_SESSION['cargo'] == 'VICE-DIR') || ($_SESSION['cargo'] == 'SECRET') || ($_SESSION['cargo'] == 'REGENTE')){  ?>              
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnNuevo_Circular" title="Nueva Circular"><i class='fas fa-edit'></i></button><br><hr>
  ...
  <script type="text/javascript">
   ...
   $('#imagenProceso').hide(); 
    ...
    "columnDefs":[{
        ...
        "targets": -1,
        "data":null,
        "defaultContent": "<?php    if (($_SESSION['cargo'] == 'Administrador') || ($_SESSION['cargo'] == 'VICE-DIR') || ($_SESSION['cargo'] == 'SECRET') || ($_SESSION['cargo'] == 'REGENTE')){  ?><button class='btn btn-danger btnBorrar_mensajeAdmin'>Borrar</button> <?php   }  ?><button class='btn btn-info btnVisor_pdf'>Visor-PDF</button> <button class='btn btn-info btnReVisor_pdf'>Re-Visor-PDF</button>",
          ...
          $.ajax({
                        ...
                        success: function(data){  
                            ...
                            urlf = data[0].url;
                                  ...
                                  vari= 'http://'+servidor+'/sistema/personal/modulos/gestionAcademicaDocente/circulares/pdfCirculares/'+urlf;
